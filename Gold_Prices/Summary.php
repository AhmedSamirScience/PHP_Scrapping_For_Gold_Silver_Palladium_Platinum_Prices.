<?php
	...
	#region content 
	 ini_set('max_execution_time', 240); //300=5 minutes
		...
		$Gold_Units = array ("Gold Ounce" , "Gold Gram Carat 24" , "Gold Gram Carat 22" , "Gold Gram Carat 21" , "Gold Gram Carat 18" , "Gold Gram Carat 14" , "Gold Gram Carat 12" , 
		                     "Gold Gram Carat 10" );
  ...
  for ( $big_i = 0 ; $big_i <$number_of_capital_cities ; $big_i ++ )
  {
    ...
    $sql_query_remove = "DELETE FROM `gold_price_summary` WHERE `Capital_City` like '$Capital_City[$big_i]' ";   
	...
	for ($k = 0 ; $k < $num_of_rows_aDataTableDetailHTML; $k++ )
	{
			...
			for ($m = 0 ; $m < $num_of_rows_Gold_Units ; $m++)
			{
				...
				{	
				   ...
				   $Gold_Price_in_US_Dollar = $num_of_rows -1;
					...
					$sql_query = " 					 
									INSERT INTO `gold_price_summary`(`Gold_Unit`  , `Gold_Price_in_Specific_Currency`, `Gold_Price_in_US_Dollar`, `Capital_City` ,                  `Date_Of_Update`,`Currency_Of_Capital_City`, `Name_Of_Currency_In_Arabic`, `Capital_City_In_Arabic`)
		...
		echo "-You have inserted data and the number of acceptance data is <b>$num_of_acceptance/8</b>." , "<br> <br>";
	 #endregion
