<?php
	...
	#region content 
	  ...
	  $html_websites = array ("http://www.goldrate24.com/gold-prices/middle-east/egypt/", "http://www.goldrate24.com/gold-prices/middle-east/united_arab_emirates/", 
		...
		$Gold_Units = array ("1 Kilogram 24K","1 Kilogram 22K","1 Kilogram 21K","1 Kilogram 18K","1 Kilogram 14K","1 Kilogram 12K","1 Kilogram 10K"  );
  ...
  for ( $big_i = 0 ; $big_i <$number_of_capital_cities ; $big_i ++ )
  {
    ...
    $sql_query_remove = "DELETE FROM `gold_price_per_kilogram` WHERE `Capital_City` like '$Capital_City[$big_i]' ";   
				...
				{	
				   ...
				   $Gold_Price_in_US_Dollar = $num_of_rows -1;
					...
					$sql_query = " 					 
								...
								INSERT INTO `gold_price_per_kilogram`(`Kilogram_Carat`, `Gold_Price_Per_Kilogram_in_Specific_Currency`, `Gold_Price_Per_Kilogram_in_US_Dollar`, `Capital_City`, `Date_Of_Update`, `Currency_Of_Capital_City`, `Name_Of_Currency_In_Arabic`, `Capital_City_In_Arabic`)  
